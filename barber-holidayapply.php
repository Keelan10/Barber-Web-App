...
<head>
    ...
    <?php 
        ...
        $startdateErr = $enddateErr = $descErr = "";
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            if ($startdateErr =="" && $enddateErr =="" && $descErr == ""){
    ...
    <div class="content">
        ...
        <form method = "post" action="<?php echo $_SERVER["PHP_SELF"];?>" class="datepicker">
            <div class="start-date" <?php if ($startdateErr != "") echo "style = \"border: 2px solid red;\"";?>>
                <label for="startdate">Start Date</label>
                <input type="date" name="startdate" value="<?php if ($startdateErr == "") echo $startdate; ?>" title = "Enter a valid start date" required> 
            </div>
            <div class="end-date" <?php if ($enddateErr != "") echo "style = \"border: 2px solid red;\"";?>>
